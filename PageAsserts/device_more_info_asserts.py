...
class DeviceMoreInfoAssert(BPO):
    ...
    def click_device_log_assert(self):
        ...
        try:
            self.wait_element_visible(loc.device_log_jump_to, module="点击设备LOG-进入设备log页面_跳转元素可见")
        except:
            return False
        else:
            return True
    ...
    def click_log_button_to_on_assert(self):
        ...
        try:
            self.wait_element_visible(loc.device_log_button_on, module="点击设备LOG_进入设备页面_点击log开关_开启log元素存在")
        except:
            value = 0
        else:
            value = 1
    ...
    def click_log_button_to_off_assert(self):
        ...
        try:
            self.wait_element_visible(loc.device_log_button_off, module="点击log开关_关闭log元素存在")
        except:
            value = 0
        else:
            value = 1
