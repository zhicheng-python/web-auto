...
class DeviceMoreInfoPageObjects(BPO):
    ...
    #点击设备LOG
    def click_device_log_obj(self):
        self.click_element(loc.device_log,module="更多-点击设备LOG")


    #点击设备log，log为关，点击开关开启
    def click_log_button_to_on_obj(self):
        self.click_element(loc.device_log_button_off,module="点击设备LOG，点击开关，开启log")

    #点击设备log，log为开，点击开关关闭
    def click_log_button_to_off_obj(self):
        time.sleep(2)
        self.click_element(loc.device_log_button_on,module="点击设备LOG，点击开关，关闭log")

    #退出log日志界面
    def exit_log_info_page_obj(self):
        pass