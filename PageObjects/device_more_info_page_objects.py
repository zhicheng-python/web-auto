...
class DeviceMoreInfoPageObjects(BPO):
    ...
    def click_device_log_obj(self):
        self.click_element(loc.device_log, module="更多_点击设备LOG")

    # 点击设备log，log为关，点击开关开启
    def click_log_button_to_on_obj(self):
        self.click_element(loc.device_log_button_off, module="点击设备LOG_点击开关_开启log")

    # 点击设备log，log为开，点击开关关闭
    def click_log_button_to_off_obj(self):
        self.click_element(loc.device_log_button_on, module="点击设备LOG_点击开关_关闭log")
