...
class TestDeviceMoreInfoPage:
    ...
    # @pytest.mark.db
    @pytest.mark.usefixtures("device_more_info_device_log")
    def test_67_click_device_log(self, device_more_info_device_log):
        logger.info("正常用例：点击设备log-成功展开log信息界面")
        assert device_more_info_device_log[6].click_device_log_assert() == True
    ...
    def test_68_click_log_button_to_on(self,device_more_info_device_log):
        ...
        assert device_more_info_device_log[6].click_log_button_to_on_assert() ==True
    ...
    def test_69_click_log_button_to_off(self,device_more_info_device_log):
        ...
        assert  device_more_info_device_log[6].click_log_button_to_off_assert() == True


    @pytest.mark.usefixtures("device_more_info_device_log")
    def exit_log_info_page(self,device_more_info_device_log):
        logger.info("正常用例：点击设备log-进入界面后，点击渠道商元素，退出log详情界面")
